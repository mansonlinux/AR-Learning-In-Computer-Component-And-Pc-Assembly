...
//by Hisyam - Ref - YT - Epi 9, 13, 17, 18, 24.
...
public static class GameEvents
{
    ...
    //**************************************************
    //To check if the selected square is a correct one or wrong one
    ...
    //This event fucntion when user select something and then user release the mouse or lift up user's finger.
